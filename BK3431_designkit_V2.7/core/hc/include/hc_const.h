 ...
 *
 * SOURCE CONTROL: $Id: hc_const.h,v 1.1 2012/05/08 23:51:54 garyf Exp $
 *    
 **********************************************************************/
...
#define LE_GATT_COMMANDS_OGF            0x0A//merge CEVA 0517
#define LE_GAP_COMMANDS_OGF             0x0B//merge CEVA 0517
#define LE_L2CAP_COMMANDS_OGF           0x0C//merge CEVA 0517
#define LE_PROFILE_COMMANDS_OGF         0x0D//merge CEVA 0517
...
#define MAX_HC_LE_COMMAND_OPCODE                       0x1F		
...
//merge CEVA 0517 start
#define H_LE_GATT_G (LE_GATT_COMMANDS_OGF << 10)                                     //merge CEVA 0517

#define LE_GATT_CLIENT_PRIMARY_SERVICE_DISCOVERY                 ( 01 + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_RELATIONSHIP_DISCOVERY   	             ( 02 + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_CHARACTERISTIC_DISCOVERY                  ( 03 + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_CHARACTERISTIC_DESCRIPTOR_DISCOVERY       ( 04 + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_CHARACTERISTIC_VALUE_READ                 ( 05 + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_CHARACTERISTIC_VALUE_WRITE                ( 06 + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_CHARACTERISTIC_DESCRIPTOR_VALUE_READ      ( 0x0B + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_CHARACTERISTIC_DESCRIPTOR_VALUE_WRITE     ( 0x0C + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_CHARACTERISTIC_VALUE_READ_MULTIPLE        ( 0x0D + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_CHARACTERISTIC_EXECUTE_WRITE              ( 0x0E + H_LE_GATT_G) //merge CEVA 0517
#define LE_GATT_CLIENT_EXCHANGE_MTU                              ( 0x11 + H_LE_GATT_G) //merge CEVA 0517
...
#define LE_GATT_SERVER_CHARACTERISTIC_VALUE_WRITE                ( 0x0F + H_LE_GATT_G)  //merge CEVA 0517
#define LE_GATT_SERVER_WRITE_PERMISSIONS                         ( 0x10 + H_LE_GATT_G)  //merge CEVA 0517
#define LE_GATT_SERVER_CHARACTERISTIC_VALUE_READ                 ( 0x14 + H_LE_GATT_G)  //merge CEVA 0517

#define MAX_LE_GATT_COMMAND_OPCODE  0x14

#define H_LE_GAP_G    (LE_GAP_COMMANDS_OGF << 10)

#define GAP_SETDISCOVERABLE                                      ( 0x01 + H_LE_GAP_G)  //merge CEVA 0517
#define GAP_SETDISCOVERY                                         ( 0x02 + H_LE_GAP_G)  //merge CEVA 0517
#define GAP_SETCONNECTABLE                                       ( 0x03 + H_LE_GAP_G)  //merge CEVA 0517
#define GAP_FINDCONNECTABLEDEVICES                               ( 0x04 + H_LE_GAP_G)  //merge CEVA 0517
#define GAP_CONNECTIONESTABLISH                                  ( 0x05 + H_LE_GAP_G)  //merge CEVA 0517
#define GAP_BROADCASTMODE								         ( 0x06 + H_LE_GAP_G)  //merge CEVA 0517
#define GAP_BROADCASTDATA		                                 ( 0x07 + H_LE_GAP_G)  //merge CEVA 0517
#define GAP_SET_AD_DATA											 ( 0x08 + H_LE_GAP_G)  //merge CEVA 0517	
#define GAP_SET_SCAN_RESP_DATA									 ( 0x09 + H_LE_GAP_G)  //merge CEVA 0517
#define GAP_DISCONNECT                                           ( 0x0A + H_LE_GAP_G)  //merge CEVA 0517
#define GAP_SET_PRIVACY                                          ( 0x0B + H_LE_GAP_G)  //merge CEVA 0517
#define MAX_LE_GAP_COMMAND_OPCODE  0x0C                                                //merge CEVA 0517

#define H_LE_L2CAP_G    (LE_L2CAP_COMMANDS_OGF << 10)                                 //merge CEVA 0517

#define L2CAP_CONNECTIONUPDATE                                   ( 0x01 + H_LE_L2CAP_G)   //merge CEVA 0517
#define MAX_LE_L2CAP_COMMAND_OPCODE  0x01


#define H_LE_PROFILE_G    (LE_PROFILE_COMMANDS_OGF << 10)                                  //merge CEVA 0517

#define CTS_PROFILE_COMMAND										 ( 0x01 + H_LE_PROFILE_G)  //merge CEVA 0517
#define NDSC_PROFILE_COMMAND								     ( 0x02 + H_LE_PROFILE_G)  //merge CEVA 0517
#define SIMPLE_PROFILE_COMMAND						     	     ( 0x03 + H_LE_PROFILE_G)  //merge CEVA 0517
#define HID_PROFILE_COMMAND							     	     ( 0x04 + H_LE_PROFILE_G)  //merge CEVA 0517
#define HRS_PROFILE_COMMAND							     	     ( 0x05 + H_LE_PROFILE_G)  //merge CEVA 0517
#define HT_PROFILE_COMMAND							     	     ( 0x06 + H_LE_PROFILE_G)  //merge CEVA 0517
#define CSC_PROFILE_COMMAND							     	     ( 0x07 + H_LE_PROFILE_G)  //merge CEVA 0517
#define RSC_PROFILE_COMMAND							     	     ( 0x08 + H_LE_PROFILE_G)  //merge CEVA 0517
#define BP_PROFILE_COMMAND                                       ( 0x09 + H_LE_PROFILE_G)  //merge CEVA 0517
#define BG_PROFILE_COMMAND                                       ( 0x0A + H_LE_PROFILE_G)  //merge CEVA 0517      
//merge CEVA 0517 end
/*****************************
...
//#define HCI_FIXED_ADDRESS_EVENT                          0x24  //merge CEVA 0517 remove
#define HCI_DEBUG_EVENT                                    0x24  //merge CEVA 0517
...
//#define SMP_SECURITY_FAILED_EVENT                          0x24//merge CEVA 0517 remove it
#define SMP_PAIRING_COMPLETE_EVENT                         0x24//merge CEVA 0517
#define SMP_PAIRING_REQUEST_EVENT                          0x25//merge CEVA 0517
#define SMP_SECURITY_REQUEST_EVENT                         0x26//merge CEVA 0517

#define GATT_COMMAND_COMPLETE_EVENT                        0x41//merge CEVA 0517
#define GATT_DISCOVER_SERVICES_EVENT               		   0x42//merge CEVA 0517
#define GATT_DISCOVER_SERVICES_BY_UUID_EVENT               0x43//merge CEVA 0517
#define GATT_DISCOVER_CHARACTERISTICS_EVENT                0x44//merge CEVA 0517
#define GATT_DISCOVER_DESCRIPTORS_EVENT                    0x45//merge CEVA 0517
#define GATT_READ_RESPONSE_EVENT                           0x46//merge CEVA 0517
#define GATT_READ_BY_TYPE_RESPONSE_EVENT                   0x47//merge CEVA 0517
#define GATT_DISCOVER_INCLUDED_SERVICES_EVENT              0x48//merge CEVA 0517
#define GATT_MAX_MTU_EVENT                                 0x49//merge CEVA 0517
//#define GATT_RELIABLE_WRITE_COMPLETE_EVENT                 0x4A  - Deprecated
#define GATT_WRITE_COMPLETE_EVENT                          0x4B//merge CEVA 0517
//#define GATT_READ_LONG_RESPONSE_EVENT                      0x4C
//#define GATT_WRITE_RESPONSE_EVENT                          0x4D  - Deprecated
#define GATT_VALUE_NOTIFICATION_EVENT                      0x4E//merge CEVA 0517
#define GATT_VALUE_INDICATION_EVENT                        0x4F//merge CEVA 0517
#define GATT_VALUE_CONFIRMATION_EVENT                      0x50//merge CEVA 0517
#define GATT_WRITE_INDICATION_EVENT                        0x51//merge CEVA 0517

#define L2CAP_CONNECTION_UPDATE_RESPONSE_EVENT             0x61//merge CEVA 0517

#define HCI_LE_APP_EVENT                                   0x71//merge CEVA 0517

#define GAP_CONNECTION_COMPLETE_EVENT                      0x81//merge CEVA 0517
