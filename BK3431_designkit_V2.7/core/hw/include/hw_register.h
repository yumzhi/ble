 ...
 *
 * SOURCE CONTROL: $Id: hw_register.h,v 1.1 2012/05/09 00:09:53 garyf Exp $
 *
 * LICENSE:
...
{ u_int32 mask; int i;                    \
    for(i=0; i < sizeof(n)*8/2; i++)                \
    {                                               \
       mask = (u_int32) ((1UL << i) | (1UL << (sizeof(n)*8-1-i))); \
