 ...
 * DATE:           1 Jun 1999
 *
 * SOURCE CONTROL: $Id: hw_lc.h,v 1.1 2012/05/09 00:09:52 garyf Exp $
 *
 * LICENSE:
...
__INLINE__ void HW_set_gio_intr_mask0(const u_int);
__INLINE__ u_int HW_get_gio_intr_mask0(void);

__INLINE__ void HW_set_gio_intr_mask1(const u_int);
__INLINE__ u_int HW_get_gio_intr_mask1(void);

__INLINE__ void HW_set_gio_intr_mask2(const u_int);
__INLINE__ u_int HW_get_gio_intr_mask2(void);

__INLINE__ void HW_set_gio_intr_mask3(const u_int);
__INLINE__ u_int HW_get_gio_intr_mask3(void);
...
__INLINE__ void HW_set_gio_intr_clr0(const u_int);
__INLINE__ void HW_set_gio_intr_clr1(const u_int);
__INLINE__ void HW_set_gio_intr_clr2(const u_int);
__INLINE__ void HW_set_gio_intr_clr3(const u_int);
...
__INLINE__ u_int HW_get_gio_intr_clr0(void);
__INLINE__ u_int HW_get_gio_intr_clr1(void);
__INLINE__ u_int HW_get_gio_intr_clr2(void);
__INLINE__ u_int HW_get_gio_intr_clr3(void);
...
__INLINE__ u_int HW_get_gio_intr0(void);
__INLINE__ u_int HW_get_gio_intr1(void);
__INLINE__ u_int HW_get_gio_intr2(void);
__INLINE__ u_int HW_get_gio_intr3(void);
...
__INLINE__ void HW_set_gio_intr0(const u_int gio_intr0);
__INLINE__ void HW_set_gio_intr1(const u_int gio_intr1);
__INLINE__ void HW_set_gio_intr2(const u_int gio_intr2);
__INLINE__ void HW_set_gio_intr3(const u_int gio_intr3);
...
*
*  Declare the functions used in accessing the Jalapeno
*  GIO control registers (typically used for RF control)
*
****************************************************************/
__INLINE__ void HW_set_gio_high(const u_int rf_high);
__INLINE__ u_int32 HW_get_gio_high(void);

__INLINE__ void HW_set_gio_low(const u_int rf_low);
__INLINE__ u_int32 HW_get_gio_low(void);
...
*
***************************************************************/
__INLINE__ void HW_set_gio0(const u_int);
__INLINE__ u_int32 HW_get_gio0(void);

__INLINE__ void HW_set_gio1(const u_int);
__INLINE__ u_int32 HW_get_gio1(void);

__INLINE__ void HW_set_gio2(const u_int);
__INLINE__ u_int32 HW_get_gio2(void);

__INLINE__ void HW_set_gio3(const u_int);
__INLINE__ u_int32 HW_get_gio3(void);


/****************************************************************
*
*    Declare the functions used in accessing the Jalapeno
*    GIO status registers (typically used for RF status)
*
****************************************************************/
__INLINE__ u_int32 HW_get_gio_status(void);

/*
 * Declare the functions used to test the GIO status register
 * accessors in software simulations
 */
__INLINE__ void HW_set_gio_status(u_int gio_status);
