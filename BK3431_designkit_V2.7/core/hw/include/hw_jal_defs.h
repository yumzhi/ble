 ...
 *     All rights reserved.
 *
 * SOURCE CONTROL: $Id: hw_jal_defs.h,v 1.1 2012/05/09 00:09:52 garyf Exp $
 *
 * COMMENTS:
 *
 ...
 */
#if defined(TERASIC)
#define JAL_CODEC_TYPE_ADDR    (0x0000003C + JAL_BASE_ADDR)
...
#define JAL_AES_INTR_MSK_ADDR		(0x00000028 + JAL_BASE_ADDR)
...
#define JAL_AES_INTR_CLR_ADDR		(0x00000028 + JAL_BASE_ADDR)
...
#define JAL_SER0_WR_CLR_ADDR  (0x00000028 + JAL_BASE_ADDR)
#define JAL_SER0_WR_CLR_SHFT  27
#define JAL_SER0_WR_CLR_MASK  0x08000000

#define JAL_AES_INTR_ADDR (0x0000002C + JAL_BASE_ADDR)
...
#define JAL_NAT_BIT_CNT_ADDR        (0x00000038 + JAL_BASE_ADDR)
 ...
 ************************************/
#if (PRH_BS_CFG_SYS_LMP_EDR_SUPPORTED==1)
#define JAL_ESCO_TX_LEN_ADDR   (0x00000720 + JAL_BASE_ADDR)
#define JAL_ESCO_TX_LEN_MASK   0x000003FF
#define JAL_ESCO_TX_LEN_SHFT   0

#define JAL_ESCO_RX_LEN_ADDR   (0x00000720 + JAL_BASE_ADDR)
#define JAL_ESCO_RX_LEN_MASK   0x03FF0000
#define JAL_ESCO_RX_LEN_SHFT   16

#define JAL_ESCO_LT_ADDR_ADDR   (0x00000720 + JAL_BASE_ADDR)
#define JAL_ESCO_LT_ADDR_MASK   0x00001c00
#define JAL_ESCO_LT_ADDR_SHFT   10

#define JAL_SCO_ROUTE_ADDR      (0x00000720 + JAL_BASE_ADDR)
...
#define JAL_SER_TIME_EARLY_ADDR         (0x0000006A + JAL_BASE_ADDR)
#define JAL_SER_TIME_EARLY_MASK          0x0000000f
#define JAL_SER_TIME_EARLY_SHFT          0

#define JAL_SER_TIME_LATE_ADDR         (0x0000006A + JAL_BASE_ADDR)
...
****************************************************************/
#if (PRH_BS_CFG_SYS_LMP_EDR_SUPPORTED==1)
#define JAL_TX_ACL_BUF_OFFSET   0x0000740
#define JAL_RX_ACL_BUF_OFFSET   0x0000B80
#define JAL_ACL_BUF_LEN   1022
#else
#define JAL_TX_ACL_BUF_OFFSET   0x0000200
#define JAL_RX_ACL_BUF_OFFSET   0x0000400
 ...
 */
#if (PRH_BS_CFG_SYS_LMP_EDR_SUPPORTED==1)
#define JAL_TX_CTRL_REG_ADDR                      (JAL_BASE_ADDR+0x0710)
#else
 ...
 */
#if (PRH_BS_CFG_SYS_LMP_EDR_SUPPORTED==1)
#define JAL_ESCO_CTRL_REG_ADDR       (JAL_BASE_ADDR+0x0720)
#else
 ...
 */
#if (PRH_BS_CFG_SYS_LMP_EDR_SUPPORTED==1)
#define JAL_RX_STATUS_GP_REG_ADDR                 (JAL_BASE_ADDR+0x0730)
#else
 ...
 */
#define JAL_EDR_CTRL_REG_ADDR (JAL_BASE_ADDR+0x700)

#define JAL_EDR_ENABLE_ADDR     (0x00000700 + JAL_BASE_ADDR)
#define JAL_EDR_ENABLE_MASK     0x00000001
#define JAL_EDR_ENABLE_SHFT		0

#define JAL_EDR_PTT_ACL_ADDR    (0x00000700 + JAL_BASE_ADDR)
#define JAL_EDR_PTT_ACL_MASK	0x00000002
#define JAL_EDR_PTT_ACL_SHFT	1

#define JAL_EDR_PTT_ESCO_ADDR   (0x00000700 + JAL_BASE_ADDR)
#define JAL_EDR_PTT_ESCO_MASK	0x00000004
#define JAL_EDR_PTT_ESCO_SHFT	2

#define JAL_EDR_SYNC_ERROR_ADDR (0x00000700 + JAL_BASE_ADDR)
#define JAL_EDR_SYNC_ERROR_MASK	0x000000f8
#define JAL_EDR_SYNC_ERROR_SHFT	3

#define JAL_EDR_RX_EDR_DELAY_ADDR (0x00000700 + JAL_BASE_ADDR)
#define JAL_EDR_RX_EDR_DELAY_MASK	0x00000f00
#define JAL_EDR_RX_EDR_DELAY_SHFT	8

#define JAL_EDR_TX_EDR_DELAY_ADDR (0x00000700 + JAL_BASE_ADDR)
...
#define JAL_BD_ADDR_ADDR     (0x00000000 + JAL_BASE_ADDR)//JAL_BASE_ADDR : 0x00801600 --> BK3431
#define JAL_BD_ADDR_MASK     0xFFFFFFFF
#define JAL_BD_ADDR_SHFT     0
...
*
****************************************************************/
#define JAL_GIO_HIGH_ADDR   (0x00000060 + JAL_BASE_ADDR) // 0x20
#define JAL_GIO_HIGH_MASK   0x000007ff
#define JAL_GIO_HIGH_SHFT   0

#define JAL_GIO_LOW_ADDR    (0x00000070 + JAL_BASE_ADDR) // 0x30
#define JAL_GIO_LOW_MASK    0x000007ff
#define JAL_GIO_LOW_SHFT    0
