 ...
 *
 *********************************************************************/
typedef struct t_adv_params {//merge CEVA 0517
	u_int32 min_interval;//merge CEVA 0517
	u_int32 max_interval;//merge CEVA 0517
	u_int8  adv_type;//merge CEVA 0517
	u_int8  adv_add_type;//merge CEVA 0517
	u_int8  init_add_type;//merge CEVA 0517
	//u_int8* p_adv_add;
	u_int8* p_init_add;//merge CEVA 0517
	u_int8  channel_map;//merge CEVA 0517
	u_int8  filter_policy;//merge CEVA 0517
} t_adv_params;//merge CEVA 0517
...
u_int32 LE_Get_Next_ADV_Timer_value(void);
...
t_error LEadv_Set_GAP_Advertising_Params(t_adv_params* p_adv_params);//merge CEVA 0517
